...
object StorageApp extends App {
  val storage = Storage(
    ...
    "form1.files" -> CollectionMetadata("files", None, "form1.files"),

    "form1.files.fileA" -> IntDefinition("fileA", None, 1, "form1.files.fileA"),
    "form1.files.fileB" -> IntDefinition("fileB", None, 2, "form1.files.fileB"),
  ...
  val newStorage = Storage.empty
    ...
    .addDefinition(storageUpdated("form1.parent")) // add object definition to root
